      ...
      <el-dialog :title="addOrSaveTxt" v-model="showInfoDialog" :modal-append-to-body="false">
        <el-form :inline="true" label-position="right" :model="infoForm" class="demo-form-inline">
          <el-row :gutter="10">
            ...
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="加工负责人" >
            ...
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="联系方式">
                <el-input v-model="infoForm.phone" placeholder="联系方式"></el-input>
						...
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="农药名称">
                <el-input v-model="infoForm.pesName" placeholder="农药名称"></el-input>
              </el-form-item>
            </el-col>
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="施药日期">
                <el-date-picker v-model="infoForm.pesTime" type="date" placeholder="选择日期" :picker-options="pickerOptions">
								</el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="施药量">
                <el-input v-model="infoForm.pesAmount" placeholder="施药量"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
    ...
    data() {
      return {
        ...
        title:[
          ...
          {"name":"施药负责人","alia":"charger"},
          {"name":"联系方式","alia":"phone"},
					{"name":"农药名称","alia":"pesName"},
					{"name":"施药日期","alia":"pesTime"},
					{"name":"施药量","alia":"pesAmount"},
        ],
        infoList:[
          {
            id: '1',
