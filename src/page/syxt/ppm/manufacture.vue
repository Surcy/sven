            ...
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="联系方式">
                <el-input v-model="infoForm.phone" placeholder="联系方式"></el-input>
						...
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="加工工序">
                <el-input v-model="infoForm.procedure" placeholder="加工工序"></el-input>
              </el-form-item>
            </el-col>
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="加工日期">
                <el-date-picker v-model="infoForm.manuTime" type="daterange"  placeholder="选择日期范围">
								</el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
...
<script>
  //import infoMap from '../../../components/baidumap/InfoMap.vue'
  export default {
    data() {
      return {
        filterKey:'',
        ...
        title:[
          ...
          {"name":"加工负责人","alia":"charger"},
          {"name":"联系方式","alia":"phone"},
					{"name":"加工工序","alia":"procedure"},
					{"name":"加工时间","alia":"manuTime"},
        ],
        infoList:[
          {
            id: '1',
            ...
            phone: '联系方式',
            procedure: '加工工序',
            manuTime: '2017/05/11-2017/06/14'
          },
          {
            id: '2',
            companyName: '黄山小荷里茶业有限公司',
