            ...
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="联系方式">
                <el-input v-model="infoForm.phone" placeholder="联系方式"></el-input>
						...
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="除草方式">
                <el-input v-model="infoForm.way" placeholder="除草方式"></el-input>
              </el-form-item>
            </el-col>
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="除草日期">
                <el-date-picker v-model="infoForm.weedTime" type="date" placeholder="选择日期" :picker-options="pickerOptions">
								</el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    data() {
      return {
        ...
        title:[
          ...
          {"name":"除草负责人","alia":"charger"},
          {"name":"联系方式","alia":"phone"},
					{"name":"除草方式","alia":"way"},
					{"name":"除草日期","alia":"weedTime"},
        ],
        infoList:[
          {
            id: '1',
