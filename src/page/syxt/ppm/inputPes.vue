      ...
      <el-dialog :title="addOrSaveTxt" v-model="showInfoDialog" :modal-append-to-body="false">
        <el-form :inline="true" label-position="right" :model="infoForm" class="demo-form-inline">
          <el-row :gutter="10">
            ...
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="130px" label="农药名称">
                <el-input v-model="infoForm.pesName" placeholder="农药名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="130px" label="有效成分及含量" >
                <el-input v-model="infoForm.ingredient" placeholder="农药有效成分及含量"></el-input>
              </el-form-item>
            </el-col>
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="130px" label="农药生产商">
                <el-input v-model="infoForm.pesCompany" placeholder="农药生产商"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="130px" label="农药生产商地址">
                <el-input v-model="infoForm.address" placeholder="农药生产商地址"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="130px" label="登记证号">
                <el-input v-model="infoForm.logo" placeholder="农药登记证号"></el-input>
              </el-form-item>
            </el-col>
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="130px" label="生产许可证号">
                <el-input v-model="infoForm.license" placeholder="农药生产许可证号"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
    ...
    data() {
      return {
        ...
        title:[
          ...
          {"name":"农药名称","alia":"pesName"},
					{"name":"有效成分及含量","alia":"ingredient"},
          {"name":"农药生产商","alia":"pesCompany"},
          {"name":"登记证号","alia":"logo"},
