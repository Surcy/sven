            ...
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="联系方式">
                <el-input v-model="infoForm.phone" placeholder="联系方式"></el-input>
						...
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="肥料名称">
                <el-input v-model="infoForm.ferName" placeholder="肥料名称"></el-input>
              </el-form-item>
            </el-col>
						<el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="施肥日期">
                <el-date-picker v-model="infoForm.ferTime" type="date" placeholder="选择日期" :picker-options="pickerOptions">
								</el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :xs="12" :sm="12" :md="12" :lg="12">
              <el-form-item label-width="80px" label="施肥量">
                <el-input v-model="infoForm.ferAmount" placeholder="施肥量"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
    ...
    data() {
      return {
        ...
        title:[
          ...
          {"name":"施肥负责人","alia":"charger"},
          {"name":"联系方式","alia":"phone"},
					{"name":"肥料名称","alia":"ferName"},
					{"name":"施肥日期","alia":"ferTime"},
					{"name":"施肥量","alia":"ferAmount"},
        ],
        infoList:[
          {
            id: '1',
